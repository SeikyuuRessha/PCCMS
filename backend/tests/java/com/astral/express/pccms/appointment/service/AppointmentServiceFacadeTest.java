...
class AppointmentServiceFacadeTest {
    ...
    void should_ProcessCreateMedicalAppointment(String ruleId, String caseId, String scenario, int dateOffsetDays, String timeStr, String expectedErrorCode) {
        ...
        if ("SUCCESS".equals(expectedErrorCode)) {
            ...
            given(workScheduleRepository.findAvailableVetIds(appointmentDate, appointmentTime)).willReturn(List.of());
    ...
    private ServiceCatalog buildMedicalService() {
        ...
        service.setBasePriceVnd(200000L);
