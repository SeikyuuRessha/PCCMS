...
class FileMediaServiceImplTest {
    ...
    private FileMediaServiceImpl fileMediaService;

    @BeforeEach
    void setUp() {
        fileMediaService = new FileMediaServiceImpl(cloudMediaStorageService, fileAssetRepository, userRepository);
    }
