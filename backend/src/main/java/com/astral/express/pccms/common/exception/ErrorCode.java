...
public enum ErrorCode {
    ...
    // 5. Reception / Boarding / Grooming
    ERR_REC_001_APPOINTMENT_NOT_FOUND("ERR_REC_001_APPOINTMENT_NOT_FOUND", 404, "Không tìm thấy lịch hẹn phù hợp"),
    ERR_REC_002_APPOINTMENT_NOT_RECEIVABLE("ERR_REC_002_APPOINTMENT_NOT_RECEIVABLE", 400, "Lịch hẹn đã bị hủy hoặc đã được tiếp nhận trước đó"),
    ERR_REC_003_PHONE_REQUIRED("ERR_REC_003_PHONE_REQUIRED", 400, "Cần nhập SĐT khi tạo nhanh lịch hẹn"),
    ERR_REC_004_ACTIVE_BOARDING_SESSION_NOT_FOUND("ERR_REC_004_ACTIVE_BOARDING_SESSION_NOT_FOUND", 404, "Thú cưng chưa có phiên lưu trú đang hoạt động"),
    ERR_REC_005_INVALID_CARE_LOG("ERR_REC_005_INVALID_CARE_LOG", 400, "Nhật ký lưu trú không hợp lệ"),
    ERR_REC_006_GROOMING_TICKET_NOT_FOUND("ERR_REC_006_GROOMING_TICKET_NOT_FOUND", 404, "Không tìm thấy phiếu dịch vụ làm đẹp"),
    ERR_REC_007_INVALID_GROOMING_STATUS_TRANSITION("ERR_REC_007_INVALID_GROOMING_STATUS_TRANSITION", 400, "Không thể chuyển thẳng sang Hoàn thành nếu chưa Đang dùng dịch vụ");
