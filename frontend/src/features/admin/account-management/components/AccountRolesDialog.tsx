    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 px-4">
            <div className="w-full max-w-xl">
                <Card title="Phân vai trò người dùng" subtitle="Chọn một vai trò cho tài khoản">
                    <div className="space-y-4">
                        ...
                        <div>
                            <p className="mb-2 text-sm font-medium text-slate-700">Vai trò được chọn</p>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center justify-between gap-3">
                                                ...
                                                <span className="text-xs">{checked ? "Đã chọn" : "Chọn"}</span>
                                            </div>
                                        </button>
                                    );
                                })}
