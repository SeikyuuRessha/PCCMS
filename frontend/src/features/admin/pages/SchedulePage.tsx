...
export function SchedulePage() {
    ...
    const [scheduleOptions, setScheduleOptions] = useState<WorkScheduleOptions>(emptyOptions);
    ...
    const loadOptions = async () => {
        try {
            const data = await getWorkScheduleOptions();
            setScheduleOptions(data);
            setOptionError("");
        } catch {
            setScheduleOptions(emptyOptions);
            setOptionError("Không tải được dữ liệu nhân sự, ca làm việc hoặc vai trò từ hệ thống.");
        }
    };
