        ...
        return (
            <div className="flex flex-col gap-1.5">
                ...
                <textarea
                    ...
                    id={inputId}
                    className={cx(
                        "w-full rounded-xl border bg-white px-3 py-2 text-[14px] text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:bg-white focus:ring-2",
                        error
